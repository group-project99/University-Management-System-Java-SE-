...
public class searchGuest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        department.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "BTech", "BCA", "BBA", "Bsc", "MIBA", "MCA", "MTech" }));
        ...
        designation.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Supervisor", "Administrator", "Clerk", "Accountant", "" }));
        ...
        jPanel3.add(clearButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 260, 160, 40));
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        PayrollMain_Guest var = new PayrollMain_Guest();
        var.setVisible(true);
